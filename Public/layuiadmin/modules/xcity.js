...
layui.define(['jquery', 'form'], function(exports) {
    ...
    var xcity = {
        render : function(spd,pName, cName, aName) {
            var p = $(spd).find('select[lay-filter=province]');
            var c = $(spd).find('select[lay-filter=city]');
            var a = $(spd).find('select[lay-filter=area]');
            var cityList = [];
            var areaList = [];
            var showP = function(provinceList) {
                p.html('');
                is_pName = false;
